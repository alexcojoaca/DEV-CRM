...
import {
  createToken,
  saveSession,
  type AgentViewingDataInchiriere,
} from "@/lib/signing-sessions-inchiriere";
...
export async function POST(request: Request) {
  try {
    ...
    const agentData: AgentViewingDataInchiriere = {
    ...
    console.error("Remote create inchiriere error:", e);
    return NextResponse.json(
