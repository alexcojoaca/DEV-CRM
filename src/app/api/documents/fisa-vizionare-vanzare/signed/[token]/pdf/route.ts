...
import { getSession, getPdfPath } from "@/lib/signing-sessions";
    ...
    return new NextResponse(buf, {
      headers: {
        ...
        "Content-Disposition": view
          ? 'inline; filename="fisa-vizionare-vanzare-semnata.pdf"'
          : 'attachment; filename="fisa-vizionare-vanzare-semnata.pdf"',
      },
    });
  } catch (e) {
    console.error("Signed PDF download error:", e);
    return NextResponse.json(
